...
| 문서 | 답하는 질문 | 상태 | 주 담당 |
|---|---|---|---|
| [위험 판정 사양](risk-spec.md) | 같은 입력이 어떤 위험 수준과 근거를 만드는가? | 구현 기준 초안 | 개발 |
...
| [백엔드 사양](backend-spec.md) | 인증·API·데이터·상태 계약은 무엇인가? | 구현 기준 초안 | 개발 |
...
| 문서 | 답하는 질문 | 상태 | 주 담당 |
|---|---|---|---|
| [기능명세서](기능명세서.md) | 제출 시 실제 동작하는 기능은 무엇인가? | 골격 | 공동 |
| [데모 가이드](demo-guide.md) | 심사자가 어떤 순서로 무엇을 확인하는가? | 골격 | 공동 |
| [운영 런북](operations-runbook.md) | 어떻게 배포·복구·모니터링하는가? | 골격 | 개발 |
